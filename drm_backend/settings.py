"""
Django settings for drm_backend project.
...
WSGI_APPLICATION = 'drm_backend.wsgi.application'
...
if 'test' in sys.argv or not bool(int(os.environ.get("PROD", "0"))):
    DATABASES['default'] = {
